...
In some situation, when we are trying to access base class function with derived class
in hybrid inheritance, compiler raise error that function is ambigious in nature as more than 1 path
exists in the code to reach base class function and compiler confused to select the path and raise this Ambiguity Error.
